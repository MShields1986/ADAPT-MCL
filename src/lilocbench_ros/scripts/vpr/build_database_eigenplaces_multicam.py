#!/usr/bin/env python3
"""
Build VPR database using EigenPlaces descriptors from all 3 cameras.
...
Usage:
    docker compose run --rm vpr scripts/vpr/build_database_eigenplaces_multicam.py \
...
def main():
    ...
    # Load model
    print("Loading EigenPlaces (ResNet50, 512d) ...")
