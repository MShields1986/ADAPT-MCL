#!/usr/bin/env python3
"""
Generate VPR candidates for a sequence using multi-camera MegaLoc.
...
Usage:
    docker compose run --rm vpr scripts/vpr/publish_vpr_candidates_megaloc_multicam.py \
        --sequence static_0 --top-k 10 --output-file /data/static_0/vpr_candidates_megaloc_multicam.txt
"""
